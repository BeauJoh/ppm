...
void PukallCipher::ascii_encrypt128(const char *in, const char *key)
{
	int count, k=0;
	short pkd, pke;
...
void PukallCipher::ascii_decrypt128(const char *in, const char *key)
{
	int count, k=0;
	short pkd, pke;
